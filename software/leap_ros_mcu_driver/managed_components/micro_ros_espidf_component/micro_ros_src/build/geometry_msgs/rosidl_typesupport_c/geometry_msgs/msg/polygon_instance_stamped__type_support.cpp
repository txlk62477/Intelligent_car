...
static const _PolygonInstanceStamped_type_support_symbol_names_t _PolygonInstanceStamped_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, geometry_msgs, msg, PolygonInstanceStamped)),
  }
};
...
{
#endif
rosidl_message_type_support_t * ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, PolygonInstanceStamped)();
rosidl_message_type_support_t * ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, geometry_msgs, msg, PolygonInstanceStamped)();
#ifdef __cplusplus
}
#endif
...
static _PolygonInstanceStamped_type_support_data_t _PolygonInstanceStamped_message_typesupport_data = {
  {
    (void*) ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, PolygonInstanceStamped),
    (void*) ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, geometry_msgs, msg, PolygonInstanceStamped),
  }
};
#else
static _PolygonInstanceStamped_type_support_data_t _PolygonInstanceStamped_message_typesupport_data = {
...
static rosidl_message_type_support_t PolygonInstanceStamped_message_type_support_handle = {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, geometry_msgs, msg, PolygonInstanceStamped)() {
  if (!::geometry_msgs::msg::rosidl_typesupport_c::PolygonInstanceStamped_message_type_support_handle.typesupport_identifier) {
    ::geometry_msgs::msg::rosidl_typesupport_c::PolygonInstanceStamped_message_type_support_handle.typesupport_identifier =
    rosidl_typesupport_c__typesupport_identifier;
  }
