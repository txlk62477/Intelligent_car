...
#include "rosgraph_msgs/msg/detail/graph__rosidl_typesupport_microxrcedds_c.h"
...
typedef rosgraph_msgs__msg__Graph _Graph__ros_msg_type;
...
{
  return (uint32_t)(
    get_serialized_size_rosgraph_msgs__msg__Graph(
...
{
  bool full_bounded;
  return max_serialized_size_rosgraph_msgs__msg__Graph(&full_bounded, 0);
}
